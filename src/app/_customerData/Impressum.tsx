  ...
  return (
    <>
      <div className=" bg-brand-colour-darker p-4 md:p-16 border-brand-border-orange border-2">
        <h2 className="m-4 mb-8 text-center text-brand-accent-4 text-4sc md:text-3sc font-carlson font-extrabold">
          Impressum
        </h2>
        <p className="mb-4 mt-6 text-sm md:text-xl">
          ...
          Verantwortlich für den Inhalt (gem. § 55 Abs. 2 RStV): Franz-Josef
          Füchtenschnieder
          <br />
        </p>
        <br />
        <h2 className="md:mb-4 text-xl  md:text-2xl font-semibold">
