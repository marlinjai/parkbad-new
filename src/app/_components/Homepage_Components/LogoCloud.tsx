...
import StadtGT from '../../media/LogoCloud/stadtGt.svg'
import Joliente from '../../media/LogoCloud/joliente_logo_mobile-dark.svg'
import FFGT from '../../media/LogoCloud/ffgt.svg'
import StadtwerkeGT from '../../media/LogoCloud/logostadtwerke.svg'

const LogoCloud = () => {
  return (
    <>
      {/* Logo cloud */}
      <div className="relative isolate mt-pz20">
