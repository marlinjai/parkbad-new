...
const Datenschutzerklaerung = () => {
  return (
    <>
      <div className=" bg-brand-colour-darker p-4 md:p-16 border-brand-border-orange border-2">
        ...
        <section>
          ...
          <p>
            ...
            Optimierung unserer Website. Wir verwenden Ihre Daten nicht, um
            Rückschlüsse auf Ihre Person zu ziehen. Informationen dieser Art
            werden von uns ggfs. anonymisiert statistisch ausgewertet, um
        ...
        <section>
          <h2 className="mb-4 mt-6 text-2xl font-semibold">Newsletter</h2>
        ...
        <section>
          ...
          <p>
            ...
            den Experten für externe Datenschutzbeauftragte (Version
            #2020-09-30).
          </p>
        </section>
      </div>
